...
@section('content')
    ...
    <form action="{{ route('slider.store') }}" method="POST" class="row gy-4">
        ...
        <div class="col-md-3">
            ...
            <input name="title_url" value="{{ old('title_url') }}" type="text" class="form-control" placeholder="عنوان لینک ..." />
            <div class="form-text text-danger">
                @error('title_url')
                    {{ $message }}
                @enderror
        ...
        <div class="col-md-3">
            ...
            <input name="url" value="{{ old('url') }}" type="text" class="form-control" placeholder="لینک ..." />
            <div class="form-text text-danger">
                @error('url')
                    {{ $message }}
                @enderror
